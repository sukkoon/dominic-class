...
**① 언어**는 색 계열 · 서체 · 히어로 모티프로 구분합니다. 반복 패턴은 쓰지 않고,
히어로에 큰 도형 하나와 현지어 워터마크만 낮은 농도로 얹습니다.

| 언어 | 계열색 | 두 번째 색 | 히어로 모티프 | 서체 |
|---|---|---|---|---|
| 🇺🇸 영어 | 코발트 블루 `#1D56B8` | 성조기 레드 `#EF3B4E` | 별 | Oswald |
| 🇯🇵 일본어 | 사쿠라 로즈 `#C9456C` | 남색 藍 `#3A5EA8` | 해 + 세이가이하(靑海波) | Noto Serif JP |
| 🇪🇸 스페인어 | 사프란 앰버 `#B5620A` | 스페인 레드 `#E03131` | 무데하르 말굽 아치 | Playfair Display |
| 🇨🇳 중국어 | 홍 紅 `#C81E2B` | 금 金 `#F0B429` | 원형 월동문 + 격자 | Noto Serif SC |
...
| `dc_instructors` | 36 | 언어×레벨×유형 전담 강사 (배정 규칙 CHECK) |
| `dc_courses` | 36 | 강의 |
