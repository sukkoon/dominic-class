...
**① 언어**는 색 계열과 히어로 모티프로 구분합니다. 반복 패턴은 쓰지 않고, 히어로에 큰 도형
하나와 현지어 워터마크만 낮은 농도로 얹습니다.

| 언어 | 계열색 | 두 번째 색 | 히어로 모티프 |
|---|---|---|---|
| 🇺🇸 영어 | `#1D56B8` | `#EF3B4E` | 별 |
| 🇯🇵 일본어 | `#C9456C` | `#3A5EA8` | 해 + 세이가이하(靑海波) |
| 🇪🇸 스페인어 | `#B5620A` | `#E03131` | 무데하르 말굽 아치 |
| 🇨🇳 중국어 | `#C81E2B` | `#F0B429` | 원형 월동문 + 격자 |
